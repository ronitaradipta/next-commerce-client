      ...
      <div className="form_container p-5 min-w-[28rem] bg-white rounded-md">
        ...
        >
          {otp.map((otpField, index) => (
            <InputElementOTP key={index} type="text" name={`otp-${index}`} value={otpField} maxLength="1" onChange={(e) => handleChangeInput(e, index)} onKeyDown={(e) => handleKeyDown(e, index)} onPaste={(e) => handlePaste(e)} required />
          ))}
        </FormCardOTP>
